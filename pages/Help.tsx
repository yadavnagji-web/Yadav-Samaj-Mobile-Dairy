    ...
    <div className="min-h-screen bg-slate-50 pb-24 px-4 pt-10 relative">
      <div className="max-w-4xl mx-auto space-y-12">
        ...
        <div className="flex justify-between items-center mb-6">
          <button 
            onClick={() => navigate('/')} 
            className="group flex items-center space-x-3 bg-white/90 backdrop-blur-md px-6 py-3 rounded-2xl border border-slate-200 shadow-sm text-slate-500 hover:text-indigo-600 hover:border-indigo-100 transition-all active:scale-95"
          >
            <svg className="w-5 h-5 group-hover:-translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M10 19l-7-7m0 0l7-7m-7 7h18" />
            </svg>
            <span className="text-[10px] font-black uppercase tracking-widest">पीछे जाएँ</span>
          </button>
          
          <div className="hidden md:block">
            <p className="text-[10px] font-black text-slate-300 uppercase tracking-[0.3em]">Support v1.1.2</p>
          </div>
        </div>
        ...
        <div className="space-y-16">
          ...
          <GuideSection title="चरण 1: नया सदस्य पंजीकरण (Registration)" icon="✨" color="indigo">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <Step num="4" title="OTP सत्यापन" text="आपके व्हाट्सएप पर आए 6 अंकों के सुरक्षा कोड (OTP) को डालकर रजिस्ट्रेशन पूरा करें।" />
            </div>
          ...
          <GuideSection title="चरण 3: AI वॉइस और QR कोड फीचर्स" icon="🤖" color="rose">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <Step num="2" title="गाँव का डिजिटल QR" text="जब आप कोई गाँव चुनते हैं, तो उसका एक विशेष QR कोड दिखता है। इसे दूसरों के साथ शेयर करें।" />
              <Step num="3" title="QR PDF डाउनलोड" text="साइड मेन्यू से 'सभी गाँव के QR कोड (PDF)' विकल्प चुनें और समाज के सभी गाँवों के कोड एक साथ प्रिंट करें।" />
          ...
          <GuideSection title="चरण 4: एडमिन पैनल (केवल प्रबंधकों के लिए)" icon="🔐" color="slate">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <Step num="1" title="एडमिन लॉगिन" text="मेन्यू में 'Login Admin' पर जाकर अपना आईडी और पासवर्ड (123456) डालें।" />
